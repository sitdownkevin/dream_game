    ...
    async def generate_information(self):
        ...
        tasks = [
            self.condition_llm.arun(
                type='true', theme=theme, background=background, character=character, dream=dream_true),
            self.condition_llm.arun(
                type='fake', theme=theme, background=background, character=character, dream=dream_fake),
        ]
        ...
        situation = await self.situation_llm.arun(
            theme=theme['theme'],
            soul=soul['soul'],
        ...
        situation_options = await self.situation_aopt_llm.arun(
            soul=soul['soul'],
            theme=theme['theme'],
            background=background['background'],
            character=character,
