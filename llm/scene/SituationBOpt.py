...
class SituationBOptLLM:
    ...
    def get_prompt(self):
        ...
        return PromptTemplate(
            ...
            input_variables=["theme", "background", "personality", "character", "dream_true", "dream_fake", "condition_true", "condition_fake", "prev_situation_description", "prev_situation_options_choice", "prev_situation_result", "current_situation_description"],
            partial_variables={
...
async def main():
    situation_bopt_llm = SituationBOptLLM()
    result = await situation_bopt_llm.arun(
        theme="科幻",
        background="未来世界",
